...
public class SafeInput
{
    ...
    public static void prettyHeader(String msg)
    {
        int width = 60;
        int rowTwoEdges = 3;
        int msgSpace = width - (rowTwoEdges * 2);
        if (msg.length() > msgSpace) {
            msg = msg.substring(0, msgSpace);
        }
        // Top row
